% !TEX root = ../main.tex
In einem digitalen Krankenhaus soll die Verwendung von Papier als Informationsmedium abgeschafft sein. Um diesen Standard zu erreichen benötigt es einer Digitalisierung der klinischen Prozesse. Dabei gibt es viele Chancen und Risiken. Um die Chancen umzusetzen und Risiken zu minimieren gibt es viele verschiedene Technologien, die durch \cite{braeutigam2017} in zwei Bereiche eingeteilt werden: Solche, die direkt die Behandlung von Patienten betrifft und IT-Funktionen, die die Versorgungsprozesse unterstützen.
