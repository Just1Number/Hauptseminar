...
\usepackage[margin=20mm,left=40mm,right=15mm]{geometry}
\usepackage[table,usenames,dvipsnames]{xcolor}
\usepackage{graphicx, wrapfig, helvet, titlesec, fancyhdr, subcaption, multirow}
\usepackage{pdfpages}
